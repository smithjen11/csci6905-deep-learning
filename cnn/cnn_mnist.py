...
def main(unused_argv):
  ...
  train_data_directory = os.path.join(ROOT_PATH, "101_ObjectCategories")
  test_data_directory = os.path.join(ROOT_PATH, "101_ObjectCategories")
  ...
  eval_data = images28  # Returns np.array
  # eval_labels = np.asarray(labels, dtype=np.int32)
